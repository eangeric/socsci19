...
const router = createBrowserRouter([
  { element: <Home />, path: "/socsci19" },
  { element: <Summary />, path: "/socsci19/summary" },
  { element: <Conclusion />, path: "/socsci19/conclusion" },
  {
    path: "/socsci19/page",
    children: [
      {
